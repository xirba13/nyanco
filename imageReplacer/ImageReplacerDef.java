...
public class ImageReplacerDef {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String newImagePath = "00065.gif"; // Imagen de reemplazo
        int imageNumber = 65; // Imagen que queremos reemplazar
        ...
        System.out.println("Tamaño del GIF en el fichero: " + (punteroAlInicio - punteroAlFinal));
        ...
        // Cerrar archivos y reemplazar el original con el modificado
        // Hacer una copia de seguridad ANTES de eliminar el original
        File originalFile = new File(filePath);
        File backupFile = new File("backup_" + filePath);
        originalFile.renameTo(backupFile); // Renombrar nyanco.sp -> backup_nyanco.sp
